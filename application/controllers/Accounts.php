...
class accounts extends CI_Controller { 
    ...
    function __construct() {
        parent::__construct();
                ...
                $this->load->model('accounts_model');                      // Load Apllication Model Here
    }

    /**default functin, redirects to login page if no accounts logged in yet***/
    public function index() 
	{
    if ($this->session->userdata('accounts_login') != 1) redirect(base_url() . 'login', 'refresh');
    if ($this->session->userdata('accounts_login') == 1) redirect(base_url() . 'accounts/dashboard', 'refresh');
    }
	  /************* / default functin, redirects to login page if no accounts logged in yet***/

    /*accounts dashboard code to redirect to accounts page if successfull login** */
    function dashboard() {
        if ($this->session->userdata('accounts_login') != 1) redirect(base_url(), 'refresh');
    ...
    if ($param1 == 'update') {
        ...
        $this->db->where('accounts_id', $this->session->userdata('accounts_id'));
        $this->db->update('accounts', $data);
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/favicon.ico/' . $this->session->userdata('accounts_id') . '.ico');
        $this->session->set_flashdata('flash_message', get_phrase('Info Updated'));
        redirect(base_url() . 'accounts/manage_profile', 'refresh');
    ...
    if ($param1 == 'change_password') {
        ...
        if ($data['new_password'] == $data['confirm_new_password']) {
           ...
           $this->db->where('accounts_id', $this->session->userdata('accounts_id'));
           $this->db->update('accounts', array('password' => $data['new_password']));
        ...
        $page_data['edit_profile']  = $this->db->get_where('accounts', array('accounts_id' => $this->session->userdata('accounts_id')))->result_array();
        $this->load->view('backend/index', $page_data);
    }
    ...
    if($param1 == 'insert'){
        ...
        redirect(base_url(). 'accounts/enquiry_category', 'refresh');
    }
    ...
    function list_enquiry ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'delete')
        {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
            redirect(base_url(). 'accounts/list_enquiry', 'refresh');
    ...
    function club ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'insert'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/club', 'refresh');
        }
    ...
    function circular($param1 = null, $param2 = null, $param3 = null){
        ...
        if ($param1 == 'insert'){
            ...
            redirect(base_url(). 'accounts/circular', 'refresh');
        }
    ...
    function parent($param1 = null, $param2 = null, $param3 = null){
        ...
        if ($param1 == 'insert'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data successfully saved'));
            redirect(base_url(). 'accounts/parent', 'refresh');
        }
    ...
    function teacher ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'insert'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/teacher', 'refresh');
        }
    ...
    /***********  The function manages Class Information  ***********************/
      function classes ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
            redirect(base_url(). 'accounts/classes', 'refresh');
        }
    ...
    function section ($param1 = null, $param2 = null, $param3 = null){
        ...
        $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
        redirect(base_url(). 'accounts/section', 'refresh');
        }
    ...
    //     $page_data['class_id']  =   $class_id;
    //     $this->load->view('backend/accounts/class_routine_section_subject_selector', $page_data);
    ...
    $this->load->view('backend/accounts/class_routine_section_subject_edit', $page_data);
    ...
    if($param1 == 'create'){
        ...
        $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
        redirect(base_url(). 'accounts/dormitory', 'refresh');
    }
    ...
    if($param1 == 'create'){
        ...
        $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
        redirect(base_url(). 'accounts/hostel_room', 'refresh');
    }
    ...
    if($param1 == 'create'){
        ...
        $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
        redirect(base_url(). 'accounts/hostel_category', 'refresh');
    }
    ...
    function academic_syllabus ($param1 = null, $param2 = null, $param3 = null){
        ...
        $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
        redirect(base_url(). 'accounts/academic_syllabus', 'refresh');
    }
    ...
    function new_student ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/student_information', 'refresh');
        }
    ...
    function getStudentClasswise($class_id){
        ...
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/accounts/showStudentClasswise', $page_data);
    }
    ...
    function manage_attendance($date = null, $month= null, $year = null, $class_id = null, $section_id = null ){
        ...
        if ($_POST) {
            ...
            redirect(base_url() . 'accounts/manage_attendance/' . $date . '/' . $month . '/' . $year . '/' . $class_id . '/' . $section_id, 'refresh');
        }
    ...
    function attendance_selector(){
        ...
        redirect(base_url(). 'accounts/manage_attendance/' .$date. '/' . $this->input->post('class_id'). '/' . $this->input->post('section_id'), 'refresh');
    }
    ...
    function attendance_report($class_id = NULL, $section_id = NULL, $month = NULL, $year = NULL) {
        ...
        if ($_POST) {
        redirect(base_url() . 'accounts/attendance_report/' . $class_id . '/' . $section_id . '/' . $month . '/' . $year, 'refresh');
        }
	...
	function loadAttendanceReport($class_id, $section_id, $month, $year)
    {
        ...
        $this->load->view('backend/accounts/loadAttendanceReport' , $page_data);
    }
    ...
    function examQuestion ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/examQuestion', 'refresh');
        }
    ...
    function createExamination ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/createExamination', 'refresh');
        }
    ...
    function student_payment ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'single_invoice'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/student_invoice', 'refresh');
        }
    ...
    function noticeboard ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/noticeboard', 'refresh');
        }
    ...
    /***********  The function that manages school events ends here ***********************/
     ...
     function manage_language ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'add_language'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/manage_language', 'refresh');
        }
    ...
    function marks ($exam_id = null, $class_id = null, $student_id = null){
            ...
            if($this->input->post('operation') == 'selection'){
                ...
                if($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['student_id'] > 0){
                    ...
                    redirect(base_url(). 'accounts/marks/'. $page_data['exam_id'] .'/' . $page_data['class_id'] . '/' . $page_data['student_id'], 'refresh');
                }
                else{
                    $this->session->set_flashdata('error_message', get_phrase('Pleasen select something'));
                    redirect(base_url(). 'accounts/marks', 'refresh');
                }
            }
            ...
            if($this->input->post('operation') == 'update_student_subject_score'){
                ...
                $select_subject_first = $this->db->get_where('subject', array('class_id' => $class_id ))->result_array();
                    ...
                    $this->session->set_flashdata('flash_message', get_phrase('Data Updated Successfully'));
                    redirect(base_url(). 'accounts/marks/'. $this->input->post('exam_id') .'/' . $this->input->post('class_id') . '/' . $this->input->post('student_id'), 'refresh');
            }
     ...
     function student_marksheet_subject ($exam_id = null, $class_id = null, $subject_id = null){
        ...
        if($this->input->post('operation') == 'selection'){
            ...
            if($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0){
                ...
                redirect(base_url(). 'accounts/student_marksheet_subject/'. $page_data['exam_id'] .'/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            }
            else{
                $this->session->set_flashdata('error_message', get_phrase('Pleasen select something'));
                redirect(base_url(). 'accounts/student_marksheet_subject', 'refresh');
            }
        }
        ...
        if($this->input->post('operation') == 'update_student_subject_score'){
            ...
            $select_student_first = $this->db->get_where('student', array('class_id' => $class_id ))->result_array();
                ...
                $this->session->set_flashdata('flash_message', get_phrase('Data Updated Successfully'));
                redirect(base_url(). 'accounts/student_marksheet_subject/'. $this->input->post('exam_id') .'/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
    ...
    /***********  The function below manages new accounts ***********************/
    function newaccountsistrator ($param1 = null, $param2 = null, $param3 = null){

        if($param1 == 'create'){
            $this->accounts_model->createNewaccountsistrator();
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'accounts/newaccounts', 'refresh');
        }

        if($param1 == 'update'){
            $this->accounts_model->updateaccountsistrator($param2);
            $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
            redirect(base_url(). 'accounts/newaccounts', 'refresh');
        }

        if($param1 == 'delete'){
            $this->accounts_model->deleteaccountsistrator($param2);
            $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
            redirect(base_url(). 'accounts/newaccounts', 'refresh');
        }

        $page_data['page_name']     = 'newaccounts';
        $page_data['page_title']    = get_phrase('New accounts');
        $this->load->view('backend/index', $page_data);
    }
    /***********  The function that manages accountsistrator ends here ***********************/

    function updateaccountsRole($param2){
        $this->accounts_model->updateAllDetailsForaccountsRole($param2);
        $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
        redirect(base_url(). 'accounts/newaccounts', 'refresh');
    }
