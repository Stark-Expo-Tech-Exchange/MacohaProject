...
<div class="panel panel-info">
		...
		<a href="<?php echo base_url();?>admin/classes/"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-plus"></i></button></a>
			...
			<!-- <div class="form-group">
					...
					<div class="alert alert-success"><?php echo get_phrase('Enroll/Register_Student'); ?>&nbsp;-&nbsp;PART B</div>
...
<!-- 
                    ...
                    <div class="col-sm-12">
							<input type="date" value="2011-08-19" id="example-date-input" class="form-control datepicker" name="am_date" required>
